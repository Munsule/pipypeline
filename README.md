...
pypipe can also be installed in the standard way for Python packages, using [pip](https://pip.pypa.io/en/stable/) or any compatible tool such as [pipx](https://github.com/Munsule/pipypeline.git).
```sh
